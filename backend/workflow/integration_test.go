...
func TestFrontendIntegration(t *testing.T) {
	// This is the exact payload format generated by src/app/page.tsx
	frontendPayload := `{
		"nodes": [
	...
	engine, err := NewEngine([]byte(frontendPayload))
	if err != nil {
...
func TestFrontendDefaultWorkflow(t *testing.T) {
	// This matches initialNodes and initialEdges from src/app/page.tsx
	defaultPayload := `{
		"nodes": [
			{"id": "1", "data": {"value": 10, "label": "Node 1"}},
			{"id": "2", "data": {"value": 5, "label": "Node 2"}},
	...
	engine, err := NewEngine([]byte(defaultPayload))
	if err != nil {
