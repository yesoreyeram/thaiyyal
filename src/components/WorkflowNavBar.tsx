...
export function WorkflowNavBar({
  ...
  return (
    <div className="py-4 h-10 bg-black-700 border-b border-gray-800 flex items-center justify-between px-2 py-2">
      <div className="flex items-center gap-3">
        {isEditing ? (
          <input
            ...
            className="bg-gray-800 border border-gray-600 rounded-lg text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-[200px]"
            aria-label="Workflow title"
          />
        ) : (
          <button
            onClick={() => setIsEditing(true)}
            className="text-white text-sm font-medium hover:bg-gray-800 rounded-lg transition-colors flex items-center gap-2 group"
