      ...
      <div className="min-h-screen flex items-center justify-center px-8">
        <div className="text-center max-w-3xl">
          ...
          <p className="text-2xl text-gray-400 mb-12 leading-relaxed">
            Build powerful workflows visually with our enterprise-grade workflow
            builder.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700/50 backdrop-blur-sm hover:border-gray-600/50 transition-all">
              ...
              <p className="text-gray-400">
                Intuitive drag & drop interface for building complex workflows
            ...
            <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700/50 backdrop-blur-sm hover:border-gray-600/50 transition-all">
              ...
              <p className="text-gray-400">
                40+ specialized node types for operations, control flow, error
                handling, and more.
              </p>
            </div>
            ...
            <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700/50 backdrop-blur-sm hover:border-gray-600/50 transition-all">
              ...
              <p className="text-gray-400">
                Enterprise-grade quality with modern dark theme and professional
                UX.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-gray-800/30 rounded-lg border border-gray-700/30">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg text-gray-200 font-medium mb-2">
                    Workflow Management
                  </h4>
                  <p className="text-sm text-gray-400">
                    Save, load, and manage multiple workflows with in-browser
                    persistence.
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 bg-gray-800/30 rounded-lg border border-gray-700/30">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Seamlessly connect nodes to define data flow and execution
                    paths.
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 bg-gray-800/30 rounded-lg border border-gray-700/30">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Export workflows as JSON for version control and sharing.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-6 bg-gray-800/30 rounded-lg border border-gray-700/30">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Boost productivity with keyboard shortcuts for common
                    actions.
                  </p>
                </div>
              </div>
